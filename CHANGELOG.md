...
## [16.0.0-SLFork](https://github.com/Slider0007/test-release/compare/v16.1.3-SLFork...v16.0.0-SLFork) (2026-09-10)
...
* **mqtt:** Complete rework of MQTT API & Add new content ([#151](https://github.com/Slider0007/test-release/issues/151))
* **REST API:** Complete rework of REST API & WebUI 'info' page ([#85](https://github.com/Slider0007/test-release/issues/85))

### Features

* **camera:** Support additional camera features ([#141](https://github.com/Slider0007/test-release/issues/141)) ([96b2d05](https://github.com/Slider0007/test-release/commit/96b2d0599e6fdd0b24eea16ab06e6fe33bef423e))
* **GPIO:** Complete rework of GPIO handler & Add additional features for GPIOs ([#154](https://github.com/Slider0007/test-release/issues/154)) ([026c650](https://github.com/Slider0007/test-release/commit/026c650e819b6dc5ec83b77cfe1cdb51361ca45f))
* **hardware:** Add support for board Seeed Studio XIAO ESP32S3 Sense ([#155](https://github.com/Slider0007/test-release/issues/155)) ([922ba2f](https://github.com/Slider0007/test-release/commit/922ba2fbfe75d2bdbdc8604051435566c587517e))
* **influxdb1+2:** Implement TLS encryption using certificates ([#105](https://github.com/Slider0007/test-release/issues/105)) ([4364427](https://github.com/Slider0007/test-release/commit/436442738c0d8b987130edfabd986b14c062ede6))
* Make camera frequency adjustable ([#79](https://github.com/Slider0007/test-release/issues/79)) ([47f19c8](https://github.com/Slider0007/test-release/commit/47f19c887cdce38ef68872cac0a69baa0be3a599))
* **mqtt:** Complete rework of MQTT API & Add new content ([#151](https://github.com/Slider0007/test-release/issues/151)) ([48ce862](https://github.com/Slider0007/test-release/commit/48ce862f64092d3caaa09ffe67f79ca75a23d538))
* **mqtt:** Implement MQTT TLS encryption using certificates ([#102](https://github.com/Slider0007/test-release/issues/102)) ([7d53c1e](https://github.com/Slider0007/test-release/commit/7d53c1e5ad9f97aea834545af6cdab18d7de2c4f))
* **REST API:** Complete rework of REST API & WebUI 'info' page ([#85](https://github.com/Slider0007/test-release/issues/85)) ([93353bb](https://github.com/Slider0007/test-release/commit/93353bb9cc499cf3ffe56790db06b57fa4541f71))
* **rest api:** Prometheus (OpenMetrics) exporter (/metrics) ([#163](https://github.com/Slider0007/test-release/issues/163)) ([7f14d89](https://github.com/Slider0007/test-release/commit/7f14d89bc013f6db145eac343d90b4b457ae11b3))
* **webui:** 'Overview'+'Data Graph': Save auto page refresh config persistently ([#113](https://github.com/Slider0007/test-release/issues/113)) ([6a36d5a](https://github.com/Slider0007/test-release/commit/6a36d5a6e18e14f684763af1bdc1794821a25658))
* **webui:** Automatic ROI naming + ROI/Alignment marker position validation ([#99](https://github.com/Slider0007/test-release/issues/99)) ([cd5b979](https://github.com/Slider0007/test-release/commit/cd5b979e8c76c3a1abe76bdf68200453285a30cd))
* **webui:** WLAN configuration via web interface ([cfc53b0](https://github.com/Slider0007/test-release/commit/cfc53b0b0daf33a19217cf9de5457bbfa84d90e8))
...
* **alignment marker:** Fix usage of preallocated RAM ([#95](https://github.com/Slider0007/test-release/issues/95)) ([5676d59](https://github.com/Slider0007/test-release/commit/5676d591dee9c2c53a918f829d2cbc059a25c9e7))
* Digit no zero crossing issue ([#74](https://github.com/Slider0007/test-release/issues/74)) ([9c1a35d](https://github.com/Slider0007/test-release/commit/9c1a35da36c6c2168e5135d3f705797c0503143e))
...
* Fix 'MaxRateType' parameter migration ([#91](https://github.com/Slider0007/test-release/issues/91)) ([5926bf8](https://github.com/Slider0007/test-release/commit/5926bf890668136f465ad594735942dd77ffc336))
* Fix exeception accessing getJPG ressource ([#121](https://github.com/Slider0007/test-release/issues/121)) ([5d114d3](https://github.com/Slider0007/test-release/commit/5d114d310279087cbeba7cb03d7549c4de6607e0))
* **gpio:** Fix GPIO handler enable flag ([#134](https://github.com/Slider0007/test-release/issues/134)) ([6f4a8f4](https://github.com/Slider0007/test-release/commit/6f4a8f4ddc625603c8efc1ddbb4e88d16f199e75))
* **gpio:** Fix init issue & wrong mode comparison ([#115](https://github.com/Slider0007/test-release/issues/115)) ([8da5982](https://github.com/Slider0007/test-release/commit/8da5982de5566f50355c6ad69dd9d5db83603e89))
* **influxdb:** Consider DST for UTC time converison ([#89](https://github.com/Slider0007/test-release/issues/89)) ([d1f77ac](https://github.com/Slider0007/test-release/commit/d1f77acb540c679132e176bd020f429855ca723c))
* **influxdbv2:** Rename parameter 'database' to 'bucket' ([#100](https://github.com/Slider0007/test-release/issues/100)) ([b2f9e11](https://github.com/Slider0007/test-release/commit/b2f9e1134f1fe1b8331a055bbeaa1679cf94b64e))
* **load fallbackvalue:** Avoid conversion exception if string is invalid ([#169](https://github.com/Slider0007/test-release/issues/169)) ([7a3219c](https://github.com/Slider0007/test-release/commit/7a3219cb97e70ddfca6119596861928249318e4e))
* **mqtt:** Fix HA problem state ([cab4597](https://github.com/Slider0007/test-release/commit/cab4597ad7dc299cb76c6dbe38637d2742681c1c))
* **mqtt:** Fix Home Assistant Topic 'Problem'  ([#130](https://github.com/Slider0007/test-release/issues/130)) ([cab4597](https://github.com/Slider0007/test-release/commit/cab4597ad7dc299cb76c6dbe38637d2742681c1c))
* **mqtt:** Fix Home Assistant topic 'problem' ([#140](https://github.com/Slider0007/test-release/issues/140)) ([926acdb](https://github.com/Slider0007/test-release/commit/926acdb500c3e688c5d1633da4140091708ca89d))
* **mqtt:** Fix Home Assistant topic problem (again) ([926acdb](https://github.com/Slider0007/test-release/commit/926acdb500c3e688c5d1633da4140091708ca89d))
* **mqtt:** Fix process init failed if MQTT not yet connected ([#139](https://github.com/Slider0007/test-release/issues/139)) ([64b63b7](https://github.com/Slider0007/test-release/commit/64b63b7892457c9048567613af75ea4646a6741c))
* **mqtt:** Reset username+password when parameter is disabled ([#122](https://github.com/Slider0007/test-release/issues/122)) ([abb0afe](https://github.com/Slider0007/test-release/commit/abb0afe699a549ec2d360e2c3875e9f7e28d22fd))
* **parameter migration:** Fix 'MaxRateType' parameter (Handling 'RateOff') ([#97](https://github.com/Slider0007/test-release/issues/97)) ([6901c01](https://github.com/Slider0007/test-release/commit/6901c0164f5aa793ac7aea78087b1cd011596198))
* **process init:** Load fallback value only with valid system time ([#149](https://github.com/Slider0007/test-release/issues/149)) ([deca53f](https://github.com/Slider0007/test-release/commit/deca53f1a8545efb67bbdc26c2ed6888ef4efc22))
* **REST API:** Fix misleading REST API send_file error ([#107](https://github.com/Slider0007/test-release/issues/107)) ([5112ce4](https://github.com/Slider0007/test-release/commit/5112ce487c97c5fc8298aecc5c363f2f350cc848))
* **REST API:** Fix rare exception for log file handling ([#112](https://github.com/Slider0007/test-release/issues/112)) ([21e61d1](https://github.com/Slider0007/test-release/commit/21e61d136f49cd5230c7cfed773c74857438a45a))
* **webui:** Add missing cycle start state message ([#133](https://github.com/Slider0007/test-release/issues/133)) ([f349a2d](https://github.com/Slider0007/test-release/commit/f349a2d078cac710a043a0309415899ff358bdf1))
* **webui:** Increase file handling robustness -&gt; handle config.ini update in firmware ([#90](https://github.com/Slider0007/test-release/issues/90)) ([c348cb3](https://github.com/Slider0007/test-release/commit/c348cb34502462f8cece141a23f9d77954e3942e))
* **webui:** Make REST API calls more robust ([#109](https://github.com/Slider0007/test-release/issues/109)) ([2909471](https://github.com/Slider0007/test-release/commit/2909471294558a4053bfcf5096e5674fe45a5bbe))
* **wlan.ini:** ChangeRSSIThreshold: Fix logging issue ([#111](https://github.com/Slider0007/test-release/issues/111)) ([4c75e4e](https://github.com/Slider0007/test-release/commit/4c75e4ec4dad2b4a291698d74283c42d27188d36))
* **wlan:** Fix deletion of array object ([#110](https://github.com/Slider0007/test-release/issues/110)) ([2f0934e](https://github.com/Slider0007/test-release/commit/2f0934ea6a566228fcc50056ab4eeb25b1f16aeb))
* **wlan:** Fix IP config output (DHCP) + Enable connection retry ([#156](https://github.com/Slider0007/test-release/issues/156)) ([869013d](https://github.com/Slider0007/test-release/commit/869013d17041c7e7282e06666e15ff50cacaca9a))


### Refactoring / Style Changes

* **build:** Refactor board type / camera model selection ([#126](https://github.com/Slider0007/test-release/issues/126)) ([54f6847](https://github.com/Slider0007/test-release/commit/54f6847dd51afeb0ab31ce36ca9513f8628ed5d2))
* Cleanup / rearrange header includes ([#117](https://github.com/Slider0007/test-release/issues/117)) ([a45431f](https://github.com/Slider0007/test-release/commit/a45431fc84f4e820fa23406819ff3291b7144cac))
* **config-handling:** Complete rework of internal config parameter and sequence data handling ([#165](https://github.com/Slider0007/test-release/issues/165)) ([cfc53b0](https://github.com/Slider0007/test-release/commit/cfc53b0b0daf33a19217cf9de5457bbfa84d90e8))
* **helper:** Move functions to system_info ([#82](https://github.com/Slider0007/test-release/issues/82)) ([40f95f8](https://github.com/Slider0007/test-release/commit/40f95f8f160f9935f1cc4cf9d31c7c5b3b0af309))
* **ota:** Refactor / cleanup OTA functions ([#123](https://github.com/Slider0007/test-release/issues/123)) ([c85bd06](https://github.com/Slider0007/test-release/commit/c85bd06b08b6c7741a51726654893d4f91254b51))
* Refactor sdkconfig.defaults ([#73](https://github.com/Slider0007/test-release/issues/73)) ([7922855](https://github.com/Slider0007/test-release/commit/79228559a38ad9069651cae04117e1aa1181549a))
* Relocate setCPUFrequency ([#88](https://github.com/Slider0007/test-release/issues/88)) ([d95c677](https://github.com/Slider0007/test-release/commit/d95c677ac78ebc4ddaca8e2b30b3cd6a74930807))
* Rename 'round' to 'cycle' ([#84](https://github.com/Slider0007/test-release/issues/84)) ([ce61169](https://github.com/Slider0007/test-release/commit/ce611697e8f6260ecd1ff68f78f72a14776011a5))
* **REST API:** Relocate REST API functions ([#83](https://github.com/Slider0007/test-release/issues/83)) ([285d8d7](https://github.com/Slider0007/test-release/commit/285d8d73e9396438ee2a082d387b02b5c53e2a41))
* **sdcard:** Refactor SD card init ([#125](https://github.com/Slider0007/test-release/issues/125)) ([e0e2a4e](https://github.com/Slider0007/test-release/commit/e0e2a4e07d0a2c8831442dd99c194a442950272a))
* **source code:** Remove trailing whitespaces ([#158](https://github.com/Slider0007/test-release/issues/158)) ([32608ac](https://github.com/Slider0007/test-release/commit/32608ac9c0bb151c250da3e7bca97ef7abf3816a))
* **timesync:** Process start only when time is synced (implement new process state, interlock configurable) ([cfc53b0](https://github.com/Slider0007/test-release/commit/cfc53b0b0daf33a19217cf9de5457bbfa84d90e8))
* **webserver:** Adapt/Align some debug log level ([#98](https://github.com/Slider0007/test-release/issues/98)) ([7e1ee91](https://github.com/Slider0007/test-release/commit/7e1ee91b6e900b00178c9570fb0b3435716a52ce))
* **webui:** Improve page loading time (async REST API calls) ([#124](https://github.com/Slider0007/test-release/issues/124)) ([4c1a1c9](https://github.com/Slider0007/test-release/commit/4c1a1c9192572b2e7fb65e48dc51f249661076da))
* **webui:** Merge Digit ROI and Analog ROI page to one page -&gt; Number Sequences ([#172](https://github.com/Slider0007/test-release/issues/172)) ([d4ff5c1](https://github.com/Slider0007/test-release/commit/d4ff5c1a8557ff3133ccb87066c773ef052fc10b))
* **webui:** Optimized mobile presenation ([#96](https://github.com/Slider0007/test-release/issues/96)) ([8cd041b](https://github.com/Slider0007/test-release/commit/8cd041b2461997652ce031537abc97a41456db97))
* **webui:** Overlay notification box e.g. after user interaction ([#108](https://github.com/Slider0007/test-release/issues/108)) ([0902669](https://github.com/Slider0007/test-release/commit/09026696210c1c089303daeacc8bece9c9a3e558))
* **webui:** Refactor reboot to ensure reliable user feedback ([#147](https://github.com/Slider0007/test-release/issues/147)) ([f9f6ad6](https://github.com/Slider0007/test-release/commit/f9f6ad677001e8a42939ef5b4b99c9dac644943d))
* **wifi:** Refactor wifi init ([#72](https://github.com/Slider0007/test-release/issues/72)) ([a707db3](https://github.com/Slider0007/test-release/commit/a707db35c2e2cd69bfb267a3678d2c0ba5c20ad6))


### Other Changes

* **build:** Add action to delete old workflow runs ([#144](https://github.com/Slider0007/test-release/issues/144)) ([2abf1f1](https://github.com/Slider0007/test-release/commit/2abf1f196204e944192e62c04624aad1bc5787f9))
* **build:** Add webinstaller deployment ([4be2d30](https://github.com/Slider0007/test-release/commit/4be2d30d4aee9de62e1e826cb235c19164994e20))
* **build:** Create release-please PR as draft ([#87](https://github.com/Slider0007/test-release/issues/87)) ([b0e039c](https://github.com/Slider0007/test-release/commit/b0e039ce49a72aafe91607dd0c4319b7de273862))
* **build:** Ensure GIT_TAG is never empty ([#86](https://github.com/Slider0007/test-release/issues/86)) ([be07db0](https://github.com/Slider0007/test-release/commit/be07db066ca28adc38a55d6e5942a31db2521a32))
* **build:** Fix build workflow (commit hash) ([#77](https://github.com/Slider0007/test-release/issues/77)) ([d7f9991](https://github.com/Slider0007/test-release/commit/d7f9991f763c202e63672dcdb6f651d1973bad4a))
* **build:** Fix build workflow (correct artifacts & release version string) ([#75](https://github.com/Slider0007/test-release/issues/75)) ([e8c8c00](https://github.com/Slider0007/test-release/commit/e8c8c00e6bc362e24ece924b51a4b6025f93d9d6))
* **build:** Fix git tag in device log ([#92](https://github.com/Slider0007/test-release/issues/92)) ([fb83eb0](https://github.com/Slider0007/test-release/commit/fb83eb07ea6442496b44080df6b83186aa4fa60c))
* **build:** Include parameter docs into this repo ([#128](https://github.com/Slider0007/test-release/issues/128)) ([6fb0b53](https://github.com/Slider0007/test-release/commit/6fb0b5308022f411cbc55a637be95a2654a035eb))
* **build:** Only one firmware package is generated which can be used to handle inital, remote and OTA update ([cfc53b0](https://github.com/Slider0007/test-release/commit/cfc53b0b0daf33a19217cf9de5457bbfa84d90e8))
* **build:** Refactor / cleanup platformio environments ([#120](https://github.com/Slider0007/test-release/issues/120)) ([cd13662](https://github.com/Slider0007/test-release/commit/cd13662d8736e06d8b09d474a557e2a686853a3c))
* **build:** Release tag gets printed twice in log: Remove one ([#137](https://github.com/Slider0007/test-release/issues/137)) ([73218c8](https://github.com/Slider0007/test-release/commit/73218c8d7207843a9322e8df9f8fa8df5d7e5b61))
* **build:** Remove folder creation during build ([#93](https://github.com/Slider0007/test-release/issues/93)) ([2d3a3ec](https://github.com/Slider0007/test-release/commit/2d3a3ec175c067260644cb7779fbdade42861539))
* **build:** Update build-release.yaml ([5aa641e](https://github.com/Slider0007/test-release/commit/5aa641ef8a6128674bec0bb7bc91971f753cea36))
* **build:** Update github actions (node 16 EOL) ([#127](https://github.com/Slider0007/test-release/issues/127)) ([263c821](https://github.com/Slider0007/test-release/commit/263c82195754d4145f88d97c61b6052f2ac22101))
* **build:** Update release-please-action ([#161](https://github.com/Slider0007/test-release/issues/161)) ([3dd78b8](https://github.com/Slider0007/test-release/commit/3dd78b801ea11421f7ef54c5ef02e462871a667e))
* **build:** Update release-please-action (node 16 EOL) ([#135](https://github.com/Slider0007/test-release/issues/135)) ([9269194](https://github.com/Slider0007/test-release/commit/926919407adce5cf7419c82fbb65cddd235d3421))
* **config file:** Add config file version tag ([#153](https://github.com/Slider0007/test-release/issues/153)) ([33258c5](https://github.com/Slider0007/test-release/commit/33258c5f9a0d2185931ea38afd2480a04d8e6a49))
* **debug:** Implement core dump handling ([#168](https://github.com/Slider0007/test-release/issues/168)) ([5b5077c](https://github.com/Slider0007/test-release/commit/5b5077c5abc802d73a00576cfa6fc84a3f10864a))
* **dependency:** Update esp-tflite-micro, esp-nn, esp32-camera, stb, miniz ([#94](https://github.com/Slider0007/test-release/issues/94)) ([7949c5d](https://github.com/Slider0007/test-release/commit/7949c5dbb8555b91ba2af4ccf67743fa9bba6d9e))
...
* **develop:** release 16.0.0-SLFork ([#71](https://github.com/Slider0007/test-release/issues/71)) ([2962282](https://github.com/Slider0007/test-release/commit/2962282dfb4fa3987f953b1902de5ddc491e4229))
* **develop:** release 16.0.0-SLFork ([#76](https://github.com/Slider0007/test-release/issues/76)) ([28af11d](https://github.com/Slider0007/test-release/commit/28af11dad0ffeff0e329b89ddc606a4ee030463b))
* **develop:** release 16.0.1-SLFork ([#76](https://github.com/Slider0007/test-release/issues/76)) ([b00942f](https://github.com/Slider0007/test-release/commit/b00942f1325ac012e67d056fea6db9c1cac41303))
* **develop:** release 16.0.1-SLFork ([#77](https://github.com/Slider0007/test-release/issues/77)) ([11dad43](https://github.com/Slider0007/test-release/commit/11dad434da9f115d16e43c2ec56ae77a2e4e3d5b))
* **develop:** release 16.0.2-SLFork ([#78](https://github.com/Slider0007/test-release/issues/78)) ([38d0a67](https://github.com/Slider0007/test-release/commit/38d0a67029f4a0933c62525e9abf7b944770644b))
* **develop:** release 16.0.2-SLFork ([#78](https://github.com/Slider0007/test-release/issues/78)) ([ce246e4](https://github.com/Slider0007/test-release/commit/ce246e472ee6bcde670aad7f661dd26da19d097e))
* **develop:** release 16.0.3-SLFork ([#85](https://github.com/Slider0007/test-release/issues/85)) ([47a4098](https://github.com/Slider0007/test-release/commit/47a409880d59b78d536cf7884511b27e5fe409e3))
* **develop:** release 16.1.0-SLFork ([#81](https://github.com/Slider0007/test-release/issues/81)) ([458dfd9](https://github.com/Slider0007/test-release/commit/458dfd97df512d6b952673c94d186dfbb7d72452))
* **develop:** release 16.1.0-SLFork ([#97](https://github.com/Slider0007/test-release/issues/97)) ([95e7a4c](https://github.com/Slider0007/test-release/commit/95e7a4cef37fb2cf7602a7bdd0ad376436a621eb))
* **develop:** release 16.1.1-SLFork ([#103](https://github.com/Slider0007/test-release/issues/103)) ([a9376d9](https://github.com/Slider0007/test-release/commit/a9376d901569138cb60ec9bcca255b42ca9df063))
* **develop:** release 16.1.1-SLFork ([#116](https://github.com/Slider0007/test-release/issues/116)) ([cd25eca](https://github.com/Slider0007/test-release/commit/cd25eca268bb51ea427f05fbd995d98d43d865be))
* **develop:** release 16.1.2-SLFork ([#108](https://github.com/Slider0007/test-release/issues/108)) ([b2282dc](https://github.com/Slider0007/test-release/commit/b2282dc2678365afd8b673e8192534f1546cd366))
* **develop:** release 16.1.2-SLFork ([#136](https://github.com/Slider0007/test-release/issues/136)) ([4ccd949](https://github.com/Slider0007/test-release/commit/4ccd949975f6f047746e2f3caf4a5735a50b9239))
* **develop:** release 16.1.3-SLFork ([#138](https://github.com/Slider0007/test-release/issues/138)) ([7b11d52](https://github.com/Slider0007/test-release/commit/7b11d5257593afc3905fc9e604fd8598362c1150))
* **develop:** release 16.2.0-SLFork ([#142](https://github.com/Slider0007/test-release/issues/142)) ([6c34b8f](https://github.com/Slider0007/test-release/commit/6c34b8f61a88d834d7fa6e70c88f7cc7877ae0b2))
* **docs:** Add some troubleshooting docs ([#132](https://github.com/Slider0007/test-release/issues/132)) ([cfd046e](https://github.com/Slider0007/test-release/commit/cfd046ed72c916b0f5f859f1ce949fd175e07940))
* **docs:** Include REST API + MQTT API description into this repo  ([#129](https://github.com/Slider0007/test-release/issues/129)) ([d3dc0a3](https://github.com/Slider0007/test-release/commit/d3dc0a3c32fa2de7735be339979b0b604b98b4cf))
* **documentation:** Fix REST API / parameter description ([#162](https://github.com/Slider0007/test-release/issues/162)) ([49f1397](https://github.com/Slider0007/test-release/commit/49f1397438b62e61b410614b7faaee41df35460b))
* **framework:** Upgrade platformio to 6.7.0 (ESP-IDF 5.2.1) ([#160](https://github.com/Slider0007/test-release/issues/160)) ([49e123e](https://github.com/Slider0007/test-release/commit/49e123e2b44d4fe7bec57a417ef3a2a089451f45))
* Modify test environment detection ([#101](https://github.com/Slider0007/test-release/issues/101)) ([2509ffe](https://github.com/Slider0007/test-release/commit/2509ffe10f235d1a38124c28ed1595be0102a597))
* **nvs:** Add staus LED blink codes for NVS init errors ([#131](https://github.com/Slider0007/test-release/issues/131)) ([f455c76](https://github.com/Slider0007/test-release/commit/f455c76dda7e7362aa3c83cd2b62d3f63c14d940))
* release 16.0.0-SLFork ([93896aa](https://github.com/Slider0007/test-release/commit/93896aa49ec5fb91334864274acb2a4b2e218fe4))
* **release/v16.1:** release 16.1.3-SLFork ([#119](https://github.com/Slider0007/test-release/issues/119)) ([66ef394](https://github.com/Slider0007/test-release/commit/66ef3948dfd30e1afed3f275db89a4d34a79a1aa))
* **repo:** Delete FeatureRequest.md ([d74aacb](https://github.com/Slider0007/test-release/commit/d74aacb42106e98877970ec354b2468e4cbf0a89))
* **repo:** Update readme ([#103](https://github.com/Slider0007/test-release/issues/103)) ([16697ad](https://github.com/Slider0007/test-release/commit/16697adb3273d09814e586d406db900010a313db))
* **repo:** Update README.md ([94c1ea0](https://github.com/Slider0007/test-release/commit/94c1ea0602bdd67ff2b618d5eba5a549a7665f0f))
* Rework build workflow (add release-please action) ([#64](https://github.com/Slider0007/test-release/issues/64)) ([113a7f3](https://github.com/Slider0007/test-release/commit/113a7f38abeaa9fb91cf05560671bcac414be303))
* **submodule:** Update esp-tflite-micro to 07c014e + esp-nn to v1.1.0 (9195e96) ([#175](https://github.com/Slider0007/test-release/issues/175)) ([7b6083f](https://github.com/Slider0007/test-release/commit/7b6083f848d2553ed0494cfb5519f1b899023bbc))
* **submodule:** Update esp32-camera to v2.0.13 (0054ab7) ([#166](https://github.com/Slider0007/test-release/issues/166)) ([2501d3b](https://github.com/Slider0007/test-release/commit/2501d3b96dd8d71f926b66a4462ffa7da517033a))
* **submodule:** Update smartleds to v3.1.3 ([#167](https://github.com/Slider0007/test-release/issues/167)) ([27c1094](https://github.com/Slider0007/test-release/commit/27c1094016761a2b338e03a6bda837f578ab4e59))
* **tflite:** Updated digit/analog models ([#114](https://github.com/Slider0007/test-release/issues/114)) ([9671208](https://github.com/Slider0007/test-release/commit/9671208dfa6af7ad6a836595b0b561a51b67a0b8))
* **tflite:** Updated digit/analog models ([#177](https://github.com/Slider0007/test-release/issues/177)) ([aceb18a](https://github.com/Slider0007/test-release/commit/aceb18a797b6f72d1d8512020cb707ef52d8d66b))
* **unity-test:** Fix compiler issue & code cleanup ([#118](https://github.com/Slider0007/test-release/issues/118)) ([9862696](https://github.com/Slider0007/test-release/commit/98626966a8973d20fdb3d06c3fd0aa7d8b429f00))
* **unity-test:** Fix some test cases ([#104](https://github.com/Slider0007/test-release/issues/104)) ([a83348a](https://github.com/Slider0007/test-release/commit/a83348a1fd19c092af3c293888c1ed5aa87124f5))
* Update static part of firmware version string ([#80](https://github.com/Slider0007/test-release/issues/80)) ([c283977](https://github.com/Slider0007/test-release/commit/c283977beb5aab74f8240564d92ded2eeb6365d2))
* **webui:** Include API docs in WebUI ([#143](https://github.com/Slider0007/test-release/issues/143)) ([ed7bfd5](https://github.com/Slider0007/test-release/commit/ed7bfd5ec7798b8d0718e1d0dd9d9bd973454987))
* **webui:** Optimize web cache control settings ([#145](https://github.com/Slider0007/test-release/issues/145)) ([95a6d7e](https://github.com/Slider0007/test-release/commit/95a6d7eb636e800a8742f336acd8f7f99abe259d))
* **wlan:** Force full RF calibration at every boot ([#170](https://github.com/Slider0007/test-release/issues/170)) ([70cee70](https://github.com/Slider0007/test-release/commit/70cee70fbdf0aed2623a41662c9d4692c826b306))
